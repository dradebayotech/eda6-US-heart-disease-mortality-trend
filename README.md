...
|-----------------------|------------------------------------|
| ![Top 20 Counties](images/Top_20_Counties_with_Highest_Age-Adjusted_Heart-Disease_Mortality.png) | ![County Choropleth](images/choropleth_map_of_Age-Adjusted_Heart-Disease_Mortality-Rate_by_County.PNG) |
